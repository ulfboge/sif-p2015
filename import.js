...
function buildImportMatchNotes(m) {
  ...
  if (m.samling) parts.push('Samling ' + m.samling);
  if (m.speltid) parts.push(m.speltid);
  return parts.join(' · ');
}
...
(async () => {
  ...
  const matches = [
    ...
    { date: '2026-05-24', opponent: 'Täby FK', venue: 'home', type: 'Träningsmatch', lag: 'Gul', plan: 'Stockhagens IP', tid: '12:30', vecka: 21, samling: '12:00', speltid: '3×20 min' },
